...
*Better leap day is a Jekyll theme for GitHub Pages. You can [preview the theme to see what it looks like](http://pages-themes.github.io/leap-day), or even [use it today](#usage).*
...
1. Add the following to your site's `_config.yml`:
    ...
    ```yml
    remote_theme: remote_theme: alexcatze/better-leap-day
    plugins:
